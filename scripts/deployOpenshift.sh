...
runuser -l $SUDOUSER -c "wget https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.5.10/openshift-install-linux-4.5.10.tar.gz"
runuser -l $SUDOUSER -c "wget https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.5.10/openshift-client-linux-4.5.10.tar.gz"
runuser -l $SUDOUSER -c "tar -xvf openshift-install-linux-4.5.10.tar.gz -C $INSTALLERHOME"
runuser -l $SUDOUSER -c "sudo tar -xvf openshift-client-linux-4.5.10.tar.gz -C /usr/bin"
